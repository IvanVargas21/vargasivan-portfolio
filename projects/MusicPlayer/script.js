...
//creates new HTML5 audio element. Audio() constructor.
const audio = new Audio()

//store current song and playbackTime of current song.
let userData = {
    //...spread operator
    songs: [...allSongs],
    currentSong: null,
...
//creates a copy of an array.assign it on songsHTML
const renderSongs = (array) =>{
    //.map() iterate on array and return a new array. create array based on existing one.
    //the callback function will be executed for each element.
...
//Optional chaining(?.) 
//prevents errors when accessing nested properties that might be null or undefined.
